...
Failures:
  ...
  1) User validation should require email
     Failure/Error: expect(user).to be_valid
     
       expected #<User id: nil, email: nil> to be valid, but got errors:
         Email can't be blank
     # ./spec/models/user_spec.rb:10:in 'block (3 levels) in <top (required)>'

  2) AuthController POST /login should return 401 for invalid credentials
     Failure/Error: expect(response).to have_http_status(:unauthorized)
     
       expected the response to have status code :unauthorized (401) but it was :ok (200)
     # ./spec/controllers/auth_controller_spec.rb:25:in 'block (3 levels) in <top (required)>'

Finished in 0.23456 seconds (files took 1.23456 seconds to load)
7 examples, 2 failures

Failed examples:

rspec ./spec/models/user_spec.rb:10 # User validation should require email
rspec ./spec/controllers/auth_controller_spec.rb:25 # AuthController POST /login should return 401 for invalid credentials`
    },
    'test-unit': {
      passing: `
Loaded suite test/run_test
Started
........
Finished in 0.123456 seconds.
8 tests, 12 assertions, 0 failures, 0 errors, 0 pendings, 0 omissions, 0 notifications
100% passed
64.82 tests/s, 97.22 assertions/s`,
      failing: `
Loaded suite test/run_test
Started
..F..E..
Finished in 0.234567 seconds.
  ...
  1) Failure:
test_email_validation(UserTest) [test/user_test.rb:15]:
<true> expected but was
<false>.

  2) Error:
test_save_user(UserTest):
NoMethodError: undefined method 'save' for nil:NilClass
    test/user_test.rb:25:in 'test_save_user'

8 tests, 10 assertions, 1 failures, 1 errors, 0 pendings, 0 omissions, 0 notifications
75% passed
34.12 tests/s, 42.65 assertions/s`
    },
    cucumber: {
      passing: `
...
Failing Scenarios:
cucumber features/auth.feature:3 # Login with valid credentials
cucumber features/auth.feature:8 # Login with invalid credentials
...
..F.E.....
======================================================================
ERROR: test_user_save (users.tests.UserModelTest)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "/app/users/tests.py", line 23, in test_user_save
    user.save()
django.db.utils.IntegrityError: NOT NULL constraint failed: users_user.email

======================================================================
FAIL: test_login_view (auth.tests.AuthViewTest)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "/app/auth/tests.py", line 15, in test_login_view
    self.assertEqual(response.status_code, 401)
AssertionError: 200 != 401

----------------------------------------------------------------------
Ran 10 tests in 1.567s
...
..F.E.....
======================================================================
ERROR: test_models.test_user_creation
----------------------------------------------------------------------
Traceback (most recent call last):
  File "/tests/test_models.py", line 23, in test_user_creation
    user.save()
AttributeError: 'NoneType' object has no attribute 'save'

======================================================================
FAIL: test_auth.test_invalid_login
----------------------------------------------------------------------
Traceback (most recent call last):
  File "/tests/test_auth.py", line 15, in test_invalid_login
    assert response.status_code == 401
AssertionError
...
export const failingTestPaths = {
  javascript: {
    ...
    mocha: ['test/auth.test.js:15', 'test/api.test.js:23'],
    vitest: ['src/utils/format.test.ts'],
    jasmine: ['spec/user.spec.js:15', 'spec/auth.spec.js:28'],
    ava: ['test/auth.test.js:15', 'test/user.test.js:28']
  },
  ruby: {
    minitest: ['test/models/user_test.rb:45', 'test/models/user_test.rb:52'],
    rspec: ['./spec/models/user_spec.rb:10', './spec/controllers/auth_controller_spec.rb:25'],
    'test-unit': ['test/user_test.rb:15', 'test/user_test.rb:25'],
    cucumber: ['features/auth.feature:3', 'features/auth.feature:8']
  },
  python: {
    pytest: ['tests/test_auth.py::test_login_invalid', 'tests/test_models.py::test_user_save'],
    unittest: ['test_email_validation (test_models.TestUser)', 'test_user_creation (test_models.TestUser)'],
    django: ['test_login_view (auth.tests.AuthViewTest)', 'test_user_save (users.tests.UserModelTest)'],
    nose2: ['test_auth.test_invalid_login', 'test_models.test_user_creation']
  }
};
