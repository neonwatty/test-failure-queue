...
import { getTestOutput, getExpectedFailures } from '../fixtures/test-outputs';
import { 
  mockProjects, 
  setupMockProject, 
  cleanupMockProject, 
  expectedDetections 
} from '../fixtures/mock-projects';
...
describe('Multi-Language Adapter Integration Tests', () => {
  ...
  describe('Test Output Parsing', () => {
    const testCases = [
      ...
      { language: 'ruby', framework: 'test-unit' },
      { language: 'ruby', framework: 'cucumber' },
      { language: 'python', framework: 'pytest' },
      { language: 'python', framework: 'unittest' },
      { language: 'python', framework: 'django' },
      { language: 'python', framework: 'nose2' }
    ];
