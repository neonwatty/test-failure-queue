...
echo "  ✅ Detected failing tests using Minitest framework"
...
echo "  - Multiple test framework support (Minitest, RSpec, Test::Unit, Cucumber)"
...
echo "  - Manually fix the bugs in lib/calculator.rb"
